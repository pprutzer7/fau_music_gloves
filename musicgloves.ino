...
void setup() {
  ...
  x = 0;
  y = 0;
  flexbaseline = (analogRead(0) + analogRead(1) + analogRead(2) /*+ analogRead(3)*/)/3;
...
void loop() {
  while(millis() < 1000){
    ...
    flex3 = analogRead(2);
    //flex4 = analogRead(3);
    flexbaseline = (flexbaseline + (flex1 + flex2 + flex3 /*+ flex4*/)/3)/2;
    }
  ...
  while(flex1 > (flexbaseline + 50) || flex2 > (flexbaseline + 50) || (flex3 > (flexbaseline + 50))/* || flex4 < flexbaseline*/){
    if(flex1 > (flexbaseline + 50) && flex2 < (flexbaseline + 50) && flex3 < (flexbaseline + 50) /*&& flex4 > flexbaseline*/){
      sawToothNote(0);
    }
    if(flex2 > (flexbaseline + 50) && flex1 < (flexbaseline + 50) && flex3 < (flexbaseline + 50)/* && flex4 > flexbaseline*/){
      sawToothNote(1);
    }
    if(flex3 > (flexbaseline + 50) && flex1 < (flexbaseline + 50) && flex2 < (flexbaseline + 50)/* && flex4 > flexbaseline*/){
      sawToothNote(2);
    }/*
